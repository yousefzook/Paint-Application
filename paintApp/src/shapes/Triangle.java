...
public class Triangle extends Shapes {
	...
	public Triangle(int x1, int y1, int x2, int y2, Color sColor, int strokeWeight, Color fColor, boolean fill,
			float tr) {
	...
	public void draw(Graphics2D g) {
		...
		if (getFill()) {
			if (getX2() < getX1() && getY2() < getY1()) {
				...
				g.drawLine(getX1() - getWidth() / 2, getY1(), getX2(), getY2());
				g.drawLine(getX2(), getY2(), getUpperRightX(), getUpperRightY());
				g.drawLine(getX1() - getWidth() / 2, getY1(), getUpperRightX(), getUpperRightY());

				int[] xarr = new int[3];
				int[] yarr = new int[3];
				xarr[0] = getX1() - getWidth() / 2;
				xarr[1] = getX2();
				...
				g.drawLine(getX1() + getWidth() / 2, getY1(), getLowerLeftX(), getLowerLeftY());
				...
				g.drawLine(getX1() - getWidth() / 2, getY1(), getLowerRightX(), getLowerRightY());
				...
				g.drawLine(getX1() + getWidth() / 2, getY1(), getUpperLeftX(), getUpperLeftY());
